...
#
# Generated by export_simulation on Sun May 03 18:00:23 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './Ant_BRAM_2.sh' script.

./Ant_BRAM_2.sh -reset_run
...
./Ant_BRAM_2.sh -noclean_files

For more information on the script, please type './Ant_BRAM_2.sh -help'.
